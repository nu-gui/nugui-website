            ...
            <div style="grid-column: span 2;">
                ...
                <div style="display: flex; gap: var(--spacing-md);">
                    <a href="https://www.linkedin.com/company/nu-gui/" 
                       ...
                       style="display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: var(--color-surface); border-radius: var(--border-radius); transition: all var(--transition-base); color: var(--color-text-primary);"
                       onmouseover="this.style.background='var(--color-primary)'; this.style.transform='translateY(-2px)'; this.style.color='white'"
                       onmouseout="this.style.background='var(--color-surface)'; this.style.transform='translateY(0)'; this.style.color='var(--color-text-primary)'">
                    ...
                    <a href="https://wa.me/27211100555" 
                       ...
                       style="display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: var(--color-surface); border-radius: var(--border-radius); transition: all var(--transition-base); color: var(--color-text-primary);"
                       onmouseover="this.style.background='var(--color-success)'; this.style.transform='translateY(-2px)'; this.style.color='white'"
                       onmouseout="this.style.background='var(--color-surface)'; this.style.transform='translateY(0)'; this.style.color='var(--color-text-primary)'">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
