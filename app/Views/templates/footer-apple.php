...
.social-icon-link[href*="wa.me"]:hover {
            ...
            <div style="grid-column: span 2;">
                ...
                <div style="display: flex; gap: var(--spacing-md);">
                    <a href="https://www.linkedin.com/company/nu-gui/" 
                       ...
                       style="display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: var(--border-radius); transition: all var(--transition-base);">
